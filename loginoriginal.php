...
<center>
	<?php
				...
				if ($nom == 'admin' && $pw == 'pw') {
				echo "<p class=\"connection\">Vous êtes maintenant connecté.</p>";
				$login = true;
				}
				else {
				echo "<p class=\"connection\">Erreur d'identification</p>";
				$login = false;
				}
	...
	<?php if ($login == false):?>
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					...
					<p class="wrong">Mauvais identifiants, veuillez réessayer :</p>
